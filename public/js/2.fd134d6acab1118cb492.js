    ...
    items: function items() {
      ...
      this.departments.forEach(function (el) {
        data.push({
          id: el.id,
          title: el.title,
          positions: _this.getPositions(el.id).length,
          employees: _this.getEmployees(el.id).length
        });
      });
      return data;
    },
