...
throw new Error("Module build failed: SyntaxError: C:/OSPanel/domains/web/resources/assets/js/pages/admin/employees/Show.vue: Unexpected token, expected , (88:2)\n\n  86 | \t\t  .then(data => console.log(data)\n  87 | \t\t  //.then(data => this.item = data)\n> 88 | \t\t}\n     | \t\t^\n  89 | \t}\n  90 | }\n  91 | \n");
