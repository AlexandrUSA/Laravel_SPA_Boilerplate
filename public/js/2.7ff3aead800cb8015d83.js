          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                _context.next = 11;
                return this.$store.dispatch('auth/updateUser', { data: data });
