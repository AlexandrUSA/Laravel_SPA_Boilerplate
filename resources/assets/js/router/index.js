...
async function beforeEach (to, from, next) {
  // Получаем возможные асинхронные компоненты и хуки и разрешаем их.
...
/**
 * Проходим по всем компонентам и суммируем их поср-ов с бглобальными
 * Возращаем массив всех посредников (строки-имена)
 *
 * @param  {Array} components
 * @return {Array}
 */
